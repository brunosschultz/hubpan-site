...
const INTERNAL_PAGES: { label: string; path: string }[] = [
  ...
  { label: 'eGovIA', path: '/govia' },
  { label: 'EXPOs', path: '/expos' },
...
const PAGE_SECTIONS: Record<string, { id: string; label: string }[]> = {
  '/': [
    ...
    { id: 'home-eco-fundador', label: 'Base Fundadora' },
  ...
  '/o-hub-pan': [
    ...
    { id: 'inst-fundador', label: 'Base Fundadora' },
    { id: 'inst-startups', label: 'Startups Afiliadas' },
    { id: 'inst-beneficios', label: 'Benefícios das Afiliadas' },
  ...
  '/prointer': [
    ...
    { id: 'prointer-jornada', label: 'Índice da jornada' },
    { id: 'prointer-sobre', label: '01 · O que é o PROINTER' },
    { id: 'prointer-publicos', label: '02 · Para Quem é o PROINTER' },
    { id: 'prointer-missao', label: '03 · A Missão (impacto)' },
    { id: 'prointer-historias', label: '04 · Histórias' },
    { id: 'prointer-resultados', label: '05 · Resultados' },
    { id: 'prointer-apoiadores', label: '06 · Apoiadores' },
    { id: 'prointer-organizacoes', label: '07 · Para Organizações' },
    { id: 'prointer-apoie', label: '08 · Formulários (Participe ou Apoie)' },
    { id: 'prointer-ecossistema', label: 'Também no HUB PAN' },
    { id: 'prointer-faq', label: 'Perguntas Frequentes' },
    { id: 'prointer-doe', label: '09 · Doe para o HUB PAN' },
    NEWSLETTER_SECTION,
  ],
  '/govia': [
    ...
    { id: 'govia-ecossistema', label: 'Também no HUB PAN' },
    { id: 'govia-faq', label: 'Perguntas Frequentes' },
    NEWSLETTER_SECTION,
  ],
  '/expos': [
    { id: 'expos-hero', label: 'Hero' },
    { id: 'expos-intro', label: 'As Três EXPOs (abertura)' },
    { id: 'expos-bh', label: 'EXPO BH®' },
    { id: 'expos-nyc', label: 'EXPO NYC®' },
    { id: 'expos-boston', label: 'EXPO BOSTON' },
    { id: 'expos-evolucao', label: 'Linha Evolutiva até o HUB PAN' },
    { id: 'expos-cta', label: 'CTA Final' },
    NEWSLETTER_SECTION,
  ],
  '/forum-mundial-ia': [
    ...
    { id: 'forum-ecossistema', label: 'Também no HUB PAN' },
