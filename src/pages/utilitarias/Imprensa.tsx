  ...
  return (
    <>
      <PageHero
        ...
        actions={<>
          <HubButton size="lg" variant="lime"><ET k="imprensa.hero.btn.presskit" v="Baixar press kit completo" l="Imprensa — botão baixar press kit (hero)" /></HubButton>
          <Link to="/contato"><HubButton size="lg" variant="blue"><ET k="imprensa.hero.btn.contato" v="Contato de imprensa" l="Imprensa — botão contato (hero)" /></HubButton></Link>
        </>}
      />
        ...
        <div className="grid lg:grid-cols-[1.7fr_1fr] gap-14">
          ...
          <div>
            ...
            <div className="rounded-[20px] p-8 mb-20" {...cardBgProps} style={{ background: cardBg }} data-animate>
              ...
              <div className="flex flex-wrap gap-4">
                <Link to="/insights"><HubButton size="sm" variant="blue"><ET k="imprensa.dados.btn.acesso" v="Solicitar acesso aos dados" l="Imprensa — botão solicitar acesso aos dados" /></HubButton></Link>
                <Link to="/contato"><HubButton size="sm" variant="outline-dark"><ET k="imprensa.dados.btn.credenciar" v="Credenciar-se como imprensa" l="Imprensa — botão credenciar-se como imprensa" /></HubButton></Link>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="rounded-[20px] p-7" {...contatoBgProps} style={{ background: contatoBg }} data-animate>
              ...
              <Link to="/contato"><HubButton size="sm" variant="lime"><ET k="imprensa.sidebar.contato.btn" v="Falar com assessoria" l="Imprensa — botão do card Contato de Imprensa" /></HubButton></Link>
            </div>
            ...
            <div className="rounded-[20px] p-7" {...cardBgProps} style={{ background: cardBg }} data-animate>
              ...
              <HubButton size="sm" variant="navy"><ET k="imprensa.sidebar.presskit.btn" v="Baixar press kit completo" l="Imprensa — botão do card Press Kit" /></HubButton>
            </div>
            ...
            <div className="rounded-[20px] p-7" {...cardBgProps} style={{ background: cardBg }} data-animate>
              ...
              <HubButton size="sm" variant="navy"><ET k="imprensa.sidebar.fotos.btn" v="Baixar álbum completo" l="Imprensa — botão do card Fotos institucionais" /></HubButton>
            </div>
