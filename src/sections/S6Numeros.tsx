...
export default function S6Numeros() {
  ...
  return (
    <section ref={ref} className="relative w-full pt-20 pb-[200px] gutter" style={{ background: '#ecedf0' }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        {CARDS.map((c) => {
          ...
          return (
            <div key={c.num} className="flex flex-col bg-white overflow-hidden" style={{ borderRadius: 20, height: 330 }} data-animate>
