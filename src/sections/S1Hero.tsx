  ...
  return (
    <section ref={ref} className="relative w-full h-screen min-h-[700px] overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-center gutter pt-[120px] max-w-[860px]">
        ...
        <h1 data-hero-text className="mb-8" style={{ fontFamily: 'Luxenta', fontWeight: 400, fontSize: 'clamp(38px, 5vw, 65px)', lineHeight: 1, letterSpacing: '-1.95px', color: '#f5f4f4', maxWidth: 703 }}>
        ...
        <div data-hero-text className="flex flex-wrap gap-4 sm:gap-6">
