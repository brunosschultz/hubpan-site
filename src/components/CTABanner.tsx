 ...
 */
export default function CTABanner({ id, title, sub, actions }: { id?: string; title: ReactNode; sub?: ReactNode; actions: ReactNode }) {
  const ref = useReveal<HTMLElement>();

  return (
    <section ref={ref} id={id} className="w-full bg-hubblue">
